	...
	<nav class="navbar navbar-default navbar-alt <?php if (theme_get_setting('sticky_header')): ?>navbar-sticky<?php endif; ?>" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand home-link" rel="home" href="<?php print $front_page; ?>">
...
<!-- Onepage Hair Braiding -->
      <?php if ($page['onepage_hairbraiding']): ?>
        <section id="hairbraiding" class="parallax-section-2">
	<div class="container">
          <?php print render($page['onepage_hairbraiding']); ?>
        </div></section> <!-- /.container, /#hair braiding -->
      <?php endif; ?>
      
<!-- Mentoring -->
      <?php if ($page['onepage_mentoring']): ?>
        <section id="mentoring" class="parallax-section-3">
	<div class="container">
          <?php print render($page['onepage_mentoring']); ?>
        </div></section> <!-- /.container, /#mentoring -->
      <?php endif; ?>

<!-- Tutoring -->
      <?php if ($page['onepage_tutoring']): ?>
        <section id="tutoring" class="parallax-section-4">
	<div class="container">
          <?php print render($page['onepage_tutoring']); ?>
        </div></section> <!-- /.container, /#tutoring -->
      <?php endif; ?>
      
<!-- Jobs -->
      <?php if ($page['onepage_jobs']): ?>
        <section id="jobs" class="parallax-section-5">
	<div class="container">
          <?php print render($page['onepage_jobs']); ?>
        </div></section> <!-- /.container, /#jobs -->
      <?php endif; ?>
...
<!-- Onepage Skills -->
      <?php if ($page['onepage_skills']): ?>
        <section id="skills" class="parallax-section-6">
	<div class="container">
...
<!-- Onepage Quotes -->
      <?php if ($page['onepage_quotes']): ?>
        <section id="quote" class="parallax-section-7">
	<div class="container">
...
<!-- Onepage Get Connected -->
      <?php if ($page['onepage_getconnected']): ?>
        <section id="get-connected" class="parallax-section-8">
	<div class="container">
...
<!-- Onepage Call to Action 1 -->
      <?php if ($page['onepage_calltoaction1']): ?>
        <section id="call-to-action-1" class="parallax-section-9">
	<div class="container">
...
<!-- Onepage Price List -->
      <?php if ($page['onepage_pricelist']): ?>
        <section id="price-list" class="parallax-section-10">
	<div class="container">
...
<!-- Onepage Testimonials -->
      <?php if ($page['onepage_testimonials']): ?>
        <section id="testimonials" class="parallax-section-11">
	<div class="container">
...
<!-- Onepage Video Section -->
      <?php if ($page['onepage_videosection']): ?>
        <section id="video-section" class="parallax-section-12">
	<div class="container">
